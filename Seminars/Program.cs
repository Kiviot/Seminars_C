...
// System.Console.WriteLine(IntervalNumber (firstNumber, secondNumber));
...
// }
// System.Console.WriteLine($"Сумма натуральных элементов между числами {firstNumber} и {secondNumber} равна: {SumIntervalDigits(firstNumber, secondNumber)}");
...
// System.Console.WriteLine($"Значение функции аккермана: Akkerman ({firstNumber}, {secondNumber}) = {A}");
